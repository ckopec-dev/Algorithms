...
3. **Combine**: The merge function compares elements from both subarrays and places them in the correct order
...
The algorithm is stable (maintains relative order of equal elements) and works well for large datasets.