...
my @another_array = (3, 1, 4, 1, 5, 9, 2, 6, 5, 3, 5);
...
- **In-place**: The merge operation requires additional space

The algorithm uses recursion to break down the problem into smaller subproblems and then combines the results to produce the final sorted array.
